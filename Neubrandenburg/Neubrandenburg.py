...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 28 13:14:53 2021
...
road = ox.graph_from_place('Neubrandenburg, Germany', network_type='drive')
...
ox.save_graph_shapefile(road_proj, filepath = r'/Users/rugi2/Documents/RUGI/OSMNX Project/Meubrandenburg Data')
...
nc = df['colors'].tolist()
fig, ax = ox.plot_graph(road, bgcolor='k', node_size=30, node_color=nc, node_edgecolor='none', node_zorder=2,
...
ax.set_title('Neubrandenburg Street Network Orientation')
plt.show()
...
ax.set_title('Neubrandenburg Street Network Orientation', y=1.1)
plt.show()