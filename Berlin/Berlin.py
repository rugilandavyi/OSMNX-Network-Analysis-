...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 28 09:11:01 2021
...
ox.save_graph_shapefile(road_proj, filepath = r'/Users/rugi2/Documents/RUGI/OSMNX Project/Berlin Data')
...
ax.set_title('Berlin Street Network Orientation')
plt.show()
...
ax.set_title('Berlin Street Network Orientation', y=1.1)
plt.show()