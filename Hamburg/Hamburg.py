...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 28 23:56:08 2021
...
road = ox.graph_from_place('Hamburg, Germany', network_type='drive')
...
ox.save_graph_shapefile(road_proj, filepath = r'/Users/rugi2/Documents/RUGI/OSMNX Project/Hamburg Data')
...
ax.set_title('Hamburg Street Network Orientation')
plt.show()
...
ax.set_title('Hamburg Street Network Orientation', y=1.1)
plt.show()