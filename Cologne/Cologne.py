...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 29 05:56:17 2021
...
road = ox.graph_from_place('Cologne, Germany', network_type='drive')
...
ox.save_graph_shapefile(road_proj, filepath = r'/Users/rugi2/Documents/RUGI/OSMNX Project/Cologne Data')
...
nc = df['colors'].tolist()
fig, ax = ox.plot_graph(road, bgcolor='k', node_size=10, node_color=nc, node_edgecolor='none', node_zorder=2,
...
ax.set_title('Cologne Road Network Orientation')
plt.show()
...
ax.set_title('Cologne Road Network Orientation', y=1.1)
plt.show()